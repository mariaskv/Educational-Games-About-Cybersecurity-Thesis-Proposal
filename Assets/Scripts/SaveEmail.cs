...
public class SaveEmail : MonoBehaviour
{
    ...
    public void UnderstandMistake(){
        ...
        if(Max > 0){
            Social.text = "Τέλεια. Χαίρομαι που κατάλαβες το λάθος σου ευτυχώς υπάρχει χρόνος να λύσεις ακόμα το κουιζ όμως η μέγιστη ανταμοιβή που μπορείς να πάρεις είναι στις 2 σωστές απαντήσεις. Αυτό σημαίνει ότι μπορείς να απαντήσεις όλες τις ερωτήσεις του κουίζ αλλά μπορείς να λάβεις ανταμοιβή για το πολύ δύο σωστές απαντήσεις.\nΤρέχα να προλάβεις.\n\n\n Και να θυμάσαι καλό είναι οι κωδικοί μας να έχουν τουλάχιστον 8-10 χαρακτήρες μέγεθος.";
        }
        else
            Social.text = "Τέλεια. Χαίρομαι που κατάλαβες το λάθος σου\nΔυστυχώς όμως δεν προλαβαίνεις να λύσεις το κουιζ και χάνεις 20 νομίσματα, ο χάκερ έχει ήδη εισβάλει στον λογαριασμό σου. Τρέχα να τον προλάβεις πρωτού παραβιάσει το ηλεκτρονικό σου ταχυδρομείο.\n\n\n Και να θυμάσαι καλό είναι οι κωδικοί μας να έχουν τουλάχιστον 8-10 χαρακτήρες μέγεθος.";
    ...
    public void UnderstandMistake2(){
        ...
        if(Max > 0){
            BankRes.text = "Τέλεια. Χαίρομαι που κατάλαβες το λάθος σου ευτυχώς υπάρχει χρόνος να λύσεις ακόμα το κουιζ όμως η μέγιστη ανταμοιβή που μπορείς να πάρεις είναι στις 2 σωστές απαντήσεις.Αυτό σημαίνει ότι μπορείς να απαντήσεις όλες τις απαντήσεις του κουίζ αλλά μπορείς να λάβεις ανταμοιβή για το πολύ δύο σωστές απαντήσεις. \nΤρέχα να προλάβεις.";
        }
        else
    ...
    public void CheckPin(){
        ...
        if(result){
            ResPin = "Το pin σου είναι πολύ μικρό σε μέγεθος και όχι αρκετά ασφαλές. Δεν μπορείς να λάβεις την επιδότηση και πληρώνεις ένα παράβολο αξίας 20ε.";
            coinsManager.lose20();
        }
        else if(result1){
            ResPin = "Το pin σου είναι το τρέχον έτος και αυτό το καθιστά μη ασφαλές. Δεν μπορείς να λάβεις την επιδότηση και πληρώνεις ένα παράβολο αξίας 20ε.";
            coinsManager.lose20();
        }
        else if(follow || follow1){
            ResPin = "Το pin σου αποτελείται από διαδοχικά ψηφία και αυτό το καθιστά μη ασφαλές. Δεν μπορείς να λάβεις την επιδότηση και πληρώνεις ένα παράβολο αξίας 20ε.";
            coinsManager.lose20();
        }
        else{
            ResPin = "Το pin σου είναι ασφαλές. Λαμβάνεις την επιδότηση για την προστασία των ψηφιακών μέσων και επιπλέον κερδίζεις 15 νομίσματα. Από αυτό το σημείο και μετά όλα σου τα ψηφιακά μέσα είναι προστατευμένα από τους τεχνικούς πληροφορικής που έχει προσλάβει ο Δήμος.";
            coinsManager.win15();
        }
        PinRes.text = ResPin;
        Box2.SetActive(true);
    ...
    public void CheckPasswordSocial(){
        ...
        if(pass.Length == 0){
            ...
            ResSocial = "Ο κωδικός σου είναι μέτριος. Μπορείς ωστόσο να λύσετε το κουιζ. Μπορείς να σκεφτείς τι θα έπρεπε ακόμα να βελτιωθεί προκειμένου να γίνει πλήρως ισχυρός;";
            continueButton.SetActive(true);
            Max = 3;
        }
        else {
    ...
    public void CheckPasswordEmail(){
        ...
        if (same || pass_length < 8){
            ...
            ResSocial = "Συνέβη κάτι μη αναμενόμενο. Μπορείς να λύσεις το κουιζ με μέγιστη ανταμοιβή τη 1 σωστή απάντηση. Αυτό σημαίνει ότι μπορείς να απαντήσεις όλες τις απαντήσεις του κουίζ αλλά μπορείς να λάβεις ανταμοιβή για το πολύ μία σωστή απάντηση.";
            Max = 1;
        }
    ...
    public void CheckPasswordBank(){
        ...
        if (same || same1 || result || result1 || result2 || pass_length < 12){
            ...
            ResBank = "Ο κωδικός σου είναι μέτριος. Μπορείς να λύσεις το κουιζ.";
            Max = 3;
            continueButton1.SetActive(true);
        }
